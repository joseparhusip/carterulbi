        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg navbar-light">
                <a href="" class="navbar-brand p-0">
                    <img src="logo/carter.png" alt="Logo">
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav mx-auto py-0">
                        ...
                        <a href="utama.php?page=detail_pemesanan" class="nav-item nav-link">Detail Pemesanan</a>
                    </div>
                    <div class="col-lg-3 col-md-3">
                        <div class="header__nav__option">
                        <a href="utama.php?page=keranjang">
                                    <img src="logo/cart.jpg" alt="Cart" style="width: 40px; height: 40px;">
                                </a>
                            <div class="profile-dropdown">
                                <a href="utama.php?page=profile&id_user=">
                                    <img src="logo/profile.png" alt="Profile" style="width: 40px; height: 40px;">
                                </a>
        ...
        <div id="carouselId" class="carousel slide" data-bs-ride="carousel" data-bs-interval="false">
            <div class="carousel-inner" role="listbox">
                <div class="carousel-item active">
                    <img src="img/motorawal1.jpg" class="img-fluid w-100" alt="First slide" />
