        ...
        <nav>
            <ul class="menu-aside">
                ...
                <li class="menu-item has-submenu">
                    ...
                    <ul class="submenu">
                        <li>
                            <a href="utama.php?page=pemesanan">Pemesanan Makanan</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="menu-item">
                    <a class="menu-link" href="utama.php?page=editprofile&id_admin=1">
                ...
                <li class="menu-item has-submenu">
                    ...
                    <ul class="submenu">
                        <li>
                            <a href="utama.php?page=ulasan&id_ulasan=">Ulasan</a>
                        </li>
                    </ul>
                </li>
            </ul>
